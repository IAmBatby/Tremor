	...
	public class Dapperblook : ModNPC
{
	...
	npc.alpha = 100;
        ...
        banner = npc.type;
        bannerItem = mod.ItemType("Dapperblook");
    }
...
{
npc.Transform(mod.NPCType("SuperDapperblook"));
}
        }
    ...
    public override void NPCLoot()
    {
        ...
        {
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("HauntHat"));
        }
        }
    }
