...
namespace Tremor.ZombieEvent.Mobs
{
	...
	public class Deadling3 : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			// banner = npc.type;
			// Todo: bannerItem = mod.ItemType("NThreeDeadlingBanner");
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/DeadlingHead3"), 1f);
