...
{
    public class RuinChest : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.showItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Ruin Chest";
                if (player.showItemIconText == "Ruin Chest")
                {
                    if (tile.frameX == 72 || tile.frameX == 90)
                    {
