...
{
	public class HolyJavelinPro : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("HolyJavelinPro");
		...
		public override void AI()
		{
			...
			if (projectile.localAI[0] > 3f)
			{
				...
				{
					int num92 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height, 57, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.1f, 100, default(Color), 0.4f);
