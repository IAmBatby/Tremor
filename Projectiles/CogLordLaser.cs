		...
		public override void AI()
		{
			...
			if (projectile.localAI[0] > 3f)
			{
				for (int num449 = 0; num449 < 4; num449++)
				{
					...
					vector34 -= projectile.velocity * ((float)num449 * 0.25f);
					...
					expr_13F6C_cp_0.position.X = expr_13F6C_cp_0.position.X + (float)(projectile.width / 2);
					Dust expr_13F90_cp_0 = Main.dust[num450];
					expr_13F90_cp_0.position.Y = expr_13F90_cp_0.position.Y + (float)(projectile.height / 2);
