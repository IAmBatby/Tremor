    ...
    public override void Kill(int timeLeft)
    {
		...
		if (Main.myPlayer == projectile.owner)
		{
			...
			for (int num161 = 0; num161 < num160; num161++)
			{
				...
				Projectile.NewProjectile(projectile.oldPosition.X + (float)(projectile.width / 2), projectile.oldPosition.Y + (float)(projectile.height / 2), value12.X, value12.Y, mod.ProjectileType("WraithCloud"), (int)((double)projectile.damage * 0.8), projectile.knockBack * 0.8f, projectile.owner, 0f, 0f);
			}
		}
    }
}}
