    ...
    public override void Kill(int timeLeft)
    {
		...
		//{
			...
			for (int num221 = 0; num221 < num220; num221++)
			{
				...
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, value17.X, value17.Y, mod.ProjectileType("SparkingCloudPro"), projectile.damage, 1f, projectile.owner, 0f, (float)Main.rand.Next(-45, 1));
			}
		//}
    }
