...
namespace Tremor.Projectiles
{
	public class ChargedArrowBoom : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("ChargedArrowBoom");
		...
		public override void AI()
		{
			...
			while (num462 < num461)
			{
				...
				num463 *= num466;
				num464 *= num466;
				int num467 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 226, 0f, 0f, 100, default(Color), 2.5f);
