...
namespace Tremor.Projectiles
{
	public class NanoDronPro : ModProjectile
	{
		...
		int ShootType = 440; // Тип выстрела (Если из ванильной терки)
		...
		public override void AI()
		{
			...
			if (projectile.localAI[0] > 3f)
			{
				...
				//{
				//	int num92 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height, 226, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, default(Color), 2f);
