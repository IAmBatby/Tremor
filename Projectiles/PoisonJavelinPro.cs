...
{
	public class PoisonJavelinPro : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("PoisonJavelinPro");
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int num159 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 2, projectile.velocity.X * 0.1f, projectile.velocity.Y * 0.1f, 0, default(Color), 0.5f);
		...
		public override void AI()
		{
			...
			if (projectile.localAI[0] > 3f)
			{
				...
				{
					int num92 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width, projectile.height, 2, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.1f, 100, default(Color), 0.4f);
