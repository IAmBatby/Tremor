...
namespace Tremor.NovaPillar.Tiles
{
	public class NovaMonolithTile : ModTile
	{
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(mod.GetTexture("NovaPillar/Tiles/NovaMonolithTile_Glowmask"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY + animate, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			return false;
		}
