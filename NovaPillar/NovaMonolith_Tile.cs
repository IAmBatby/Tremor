...
{
	public class NovaMonolith_Tile : ModTile
	{
		...
		{
			Item.NewItem(i * 16, j * 16, 32, 48, mod.ItemType("NovaMonolith"));
		}
		...
		public override void NearbyEffects(int i, int j, bool closer)
		{
			...
			{
				TremorPlayer modPlayer = Main.LocalPlayer.GetModPlayer<TremorPlayer>(mod);
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Main.spriteBatch.Draw(mod.GetTexture("NovaPillar/NovaMonolith_TileGlow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.frameX, tile.frameY + animate, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			return false;
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.showItemIcon2 = mod.ItemType("NovaMonolith");
		}
