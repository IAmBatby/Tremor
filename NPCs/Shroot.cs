...
public class Shroot : ModNPC
{
	...
	npc.scale = 0.7f;
        ...
        banner = npc.type;
        bannerItem = mod.ItemType("ShrootBanner");
    }
    ...
    public override void NPCLoot()
    {
        ...
        if(Main.rand.Next(1) == 0)
        {
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("RockHorn"), Main.rand.Next(1,2));
        }
        }
    }
    ...
    public override float SpawnChance(NPCSpawnInfo spawnInfo)
    {
        ...
        return (Tremor.NoZoneAllowWater(spawnInfo)) && y > Main.rockLayer ? 0.003f : 0f;
    }
